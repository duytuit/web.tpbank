...
class UserController extends Controller
{
     ...
     * Update user
     *
     * @param UserProfilesRequest $request
     * @param int $id
     *
     * @return JsonResponse
     * @throws AuthorizationException
     ...
     *     description="",
     *     summary="Change Profiles",
     *     operationId="change_profiles",
     *     tags={"change profiles"},
     *     security={{ "apiAuth": {} }},
     *     @OA\RequestBody(
     *         required=true,
     *          @OA\JsonContent(
     ...
     *           @OA\Property(property="date_of_birth",example="yyyy-mm-dd"),
     *           @OA\Property(property="gender", example="Male/Female"),
     ...
     * )
     * */
    public function updateWithApi(UserProfilesRequest $request, $id)
    {
        $user = $this->repo->findOrFail($id);
        ...
        if(isset($request->email)){
            try {
                ...
                throw ValidationException::withMessages(['message' => trans('user.user_already_email')]);
            }
        }
        if(isset($request->phone)){
            try {
                ...
                throw ValidationException::withMessages(['message' => trans('user.user_already_phone')]);
            }
        }
